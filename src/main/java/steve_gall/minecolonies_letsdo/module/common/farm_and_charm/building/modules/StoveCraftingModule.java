...
public class StoveCraftingModule extends FarmAndCharmCraftingModule
{
	public StoveCraftingModule(JobEntry jobEntry, boolean isBakery)
	{
	...
	{
		return super.getParticlePosition(pos);
	}

	@Override
	public @NotNull String getId()
	{
		return "lets_do_farm_and_charm_stove";
	}
	...
	{
		return InteractionMessageHelper.getWorkingBlockNotFound(ObjectRegistry.STOVE.get());
	}
