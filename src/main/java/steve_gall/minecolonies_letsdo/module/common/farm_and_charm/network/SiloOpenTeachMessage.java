...
{
	public static final CustomPacketPayload.Type<SiloOpenTeachMessage> TYPE = new CustomPacketPayload.Type<>(MineColoniesCompatibility.rl("lets_do_farm_and_charm_silo_open_teach"));
	...
	public SiloOpenTeachMessage(RegistryFriendlyByteBuf buffer)
	{
		super(buffer);
	}
	...
	@Override
	public CustomPacketPayload.Type<SiloOpenTeachMessage> type()
	{
		return TYPE;
	}
