...
{
	public static final CustomPacketPayload.Type<RoasterOpenTeachMessage> TYPE = new CustomPacketPayload.Type<>(MineColoniesCompatibility.rl("lets_do_farm_and_charm_roaster_open_teach"));
	...
	public RoasterOpenTeachMessage(RegistryFriendlyByteBuf buffer)
	{
		super(buffer);
	}
	...
	@Override
	public CustomPacketPayload.Type<RoasterOpenTeachMessage> type()
	{
		return TYPE;
	}
