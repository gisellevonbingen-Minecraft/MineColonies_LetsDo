...
{
	public PotGenericRecipe(RecipeHolder<CookingPotRecipe> recipe, HolderLookup.Provider provider)
	{
		super(recipe, Arrays.asList(recipe.value().getContainerItem()), provider);
	}
