...
public class RoasterCraftingModule extends AbstractCraftingModuleWithExternalWorkingBlocks
{
	public RoasterCraftingModule(JobEntry jobEntry)
	{
		super(jobEntry);
	}
	...
	{
		return level.getBlockEntity(pos) instanceof RoasterBlockEntity roaster && roaster.isBeingBurned();
	}
	...
	{
		return "lets_do_farm_and_charm_roaster";
	}

	@Override
	public Set<CraftingType> getSupportedCraftingTypes()
	{
		return Collections.singleton(ModuleCraftingTypes.ROASTER.get());
	}
	...
	{
		return InteractionMessageHelper.getWorkingBlockAndUnderHeatSourceNotFound(ObjectRegistry.ROASTER.get());
	}
