...
public class MincerCraftingModule extends AbstractCraftingModuleWithExternalWorkingBlocks
{
	public MincerCraftingModule(JobEntry jobEntry)
	{
		super(jobEntry);
	}
	...
	{
		return level.getBlockEntity(pos) instanceof MincerBlockEntity;
	}
	...
	{
		return "lets_do_farm_and_charm_mincer";
	}

	@Override
	public Set<CraftingType> getSupportedCraftingTypes()
	{
		return Collections.singleton(ModuleCraftingTypes.MINCER.get());
	}
	...
	{
		return InteractionMessageHelper.getWorkingBlockNotFound(ObjectRegistry.MINCER.get());
	}
