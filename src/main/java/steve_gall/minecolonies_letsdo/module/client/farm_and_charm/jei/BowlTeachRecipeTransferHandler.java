...
public class BowlTeachRecipeTransferHandler extends TeachRecipeTransferHandler<BowlTeachMenu, RecipeHolder<CraftingBowlRecipe>, RecipeInput, CraftingBowlRecipe>
{
	...
	@Override
	protected RecipeHolder<CraftingBowlRecipe> getRecipe(BowlTeachMenu menu, CraftingBowlRecipe categoryRecipe, IRecipeSlotsView recipeSlots, Player player)
	{
		return new RecipeHolder<>(HOLDER_NAME, categoryRecipe);
	}

	@Override
	protected void serializePayload(BowlTeachMenu menu, RecipeHolder<CraftingBowlRecipe> recipe, IRecipeSlotsView recipeSlots, Player player, CompoundTag tag)
	{
