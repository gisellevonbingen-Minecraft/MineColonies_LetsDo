...
public class RoasterTeachRecipeTransferHandler extends TeachRecipeTransferHandler<RoasterTeachMenu, RecipeHolder<RoasterRecipe>, RecipeInput, RoasterRecipe>
{
	...
	@Override
	protected RecipeHolder<RoasterRecipe> getRecipe(RoasterTeachMenu menu, RoasterRecipe categoryRecipe, IRecipeSlotsView recipeSlots, Player player)
	{
		return new RecipeHolder<>(HOLDER_NAME, categoryRecipe);
	}

	@Override
	protected void serializePayload(RoasterTeachMenu menu, RecipeHolder<RoasterRecipe> recipe, IRecipeSlotsView recipeSlots, Player player, CompoundTag tag)
	{
