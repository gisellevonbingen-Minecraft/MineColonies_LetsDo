...
public class RoasterTeachScreen extends TeachCraftingRecipeScreen<RoasterTeachMenu, RecipeHolder<RoasterRecipe>>
{
	...
	@Override
	protected ICustomizedRecipeStorage createRecipeStorage(RecipeHolder<RoasterRecipe> recipe, List<ItemStorage> input)
	{
		...
		return new RoasterRecipeStorage(recipe.id(), input, container, output);
	}
